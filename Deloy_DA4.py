...
image = Image.open('what-is-sentiment-analysis-cover.jpg')
    ...
    with st.form(key='emotion_clf_form'):
        ...
        if submit:
            ...
            if vec_tf[0] and  vec_bow[0] and vec_w2v  == 1:
                ...
                st.write("LSTM + Word2Vec dự đoán: Tích cực 🤗")
                ...
                st.write("LSTM + Word2Vec dự đoán: Tiêu cực 😔")
